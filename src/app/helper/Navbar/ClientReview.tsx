...
const ClientReview = ({image,name}:Props) => {
  return (
    <div className='p-4'>
      <div>
        <Image src={`${image}`} alt={name} height={80} width={80}  className='rounded-full mx-auto'/>
      </div>
      <p className='mt-[2rem] text-center text-[16px] text-black opacity-60'>
       Lorem ipsum, dolor sit amet consectetur adipisicing elit. Commodi excepturi earum, explicabo minus rerum recusandae laborum illo nisi quibusdam accusamus.   
      </p>
